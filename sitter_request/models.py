...
class SitterRequest(models.Model):
    ...
    service_date = models.DateTimeField(auto_now_add=True)  #fix this
    ...
    attempt_sitter_pair_id = models.CharField(max_length=200, null=True)   #should be integer field
    paired_sitter_id = models.CharField(max_length=200, null=True)         #should be integer field  
